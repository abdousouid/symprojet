...
/**
 * @ORM\Entity(repositoryClass=VilleEtapeRepository::class)
 */
class VilleEtape
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Ville::class, inversedBy="villeEtapes")
     * @ORM\JoinColumn(nullable=false)
     */
    private $ville_etape;

    /**
     * @ORM\ManyToOne(targetEntity=Circuit::class, inversedBy="villeEtapes")
     * @ORM\JoinColumn(nullable=false)
     */
